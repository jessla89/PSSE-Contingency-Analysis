...
\caption{Count of scenarios for which (N-1) contingency cases failed to converge -  Year 1, Topology 1}
...
\begin{table}[H]
\caption{Count of scenarios for which (N-1) contingency failed to converge - Year 2, Topology 2}
\label{y2t2cb}
...
\begin{table}[H]
\caption{Count of scenarios for which (N-1) contingency failed to converge - Year 3, Topology 3}
\label{y3t3cb}
\centering
\scalebox{0.8}{\begin{tabular}{lr}
\toprule
...
\begin{table}[H]
\caption{Count of scenarios for which (N-1) contingency failed to converge - Year 3, Topology 4}
\label{y3t4cb}
\centering
\scalebox{0.8}{\begin{tabular}{lr}
\toprule
...
\begin{table}[H]
\caption{Count of scenarios for which (N-1) contingency failed to converge - Year 4, Topology 5}
\label{y4t5cb}
\centering
\scalebox{0.8}{\begin{tabular}{lr}
\toprule
...
\begin{table}[H]
\caption{Count of scenarios for which (N-1) contingency failed to converge - Year 5, Topology 6}
\label{y5t6cb}
\centering
\scalebox{0.8}{\begin{tabular}{lr}
\toprule
...
\begin{table}[H]
\caption{Branch Overload Violation Count - Contingency}
\label{y1t1ol}
\centering
